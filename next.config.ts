        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://www.google-analytics.com https://www.googletagmanager.com https://res.cloudinary.com https://use.typekit.net https://p.typekit.net https://connect.facebook.net https://www.facebook.com https://capig.stape.ma",
              "frame-src 'self'",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
