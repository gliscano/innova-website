        ...
        <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-4">
          ...
          <div className="hidden md:flex space-x-4 pt-4">
            <div className="flex justify-center items-center space-x-4 md:order-2">
              <a href="https://www.instagram.com/innova54.store" className="text-gray-600 hover:text-gray-500">
              ...
              <a href="https://www.facebook.com/innova54.store" className="text-gray-600 hover:text-gray-500">
              ...
              <a
                className="rounded-full border border-solid border-black/[.145] dark:border-white/[.145] text-gray-800 transition-colors flex items-center justify-center hover:bg-[#f2f2f2] dark:hover:bg-[#1a1a1a] hover:border-transparent text-sm sm:h-8 sm:px-5 sm:min-w-42"
