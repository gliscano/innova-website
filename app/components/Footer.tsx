            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul role="list" className="mt-4 space-y-4">
                  ...
                  <li>
                    <a href="https://www.facebook.com/innova54.store" className="text-sm text-gray-600 hover:text-blue-600 flex items-center">
                  ...
                  <li>
                    <a href="https://www.tiktok.com/@innova54.store" className="text-sm text-gray-600 hover:text-blue-600 flex items-center">
                  ...
                  <li>
                  <a href="https://ar.pinterest.com/innova54store/" className="text-sm text-gray-600 hover:text-blue-600 flex items-center">
              ...
              <div className="mt-6 md:mt-0">
                ...
                <ul role="list" className="mt-4 space-y-4">
                  ...
                  <li>
                    <a
                      className="text-sm text-gray-500 hover:text-gray-900 flex items-center text-left"
